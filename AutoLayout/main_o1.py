...
import sys
import shutil
from AutoLayout.helpers import listfile
sys.path.append("..")
...
DATASET = module_path + '/dataset.xlsx'
OUTFILE = module_path + '/checkresults.csv'
FLOOR_TAG = 'Floor'
...
functional_zone = {
    ...
    AutoLayout.bedroom.Base.Bedroom.__name__: {
                                    AutoLayout.settings.BEDROOM_TYPE[0]: AutoLayout.bedroom.Base.Bedroom,
                                    AutoLayout.settings.BEDROOM_TYPE[1]: AutoLayout.tatami_room.Base.TatamiRoom,
                                    AutoLayout.settings.BEDROOM_TYPE[2]: AutoLayout.schoolroom.Base.Schoolroom,
                                    AutoLayout.settings.BEDROOM_TYPE[3]: AutoLayout.eldersroom.Base.Eldersroom,
                                    AutoLayout.settings.BEDROOM_TYPE[4]: AutoLayout.childrenroom.Base.Childrenroom},
...
class_tupe_dict = {
    ...
    AutoLayout.childrenroom.Base.Childrenroom.__name__: ['儿童房', ()],
...
region_product_name = ['主卧产品名称', '客房产品名称', '榻榻米产品名称', '客厅产品名称', '厨房产品名称', '餐厅产品名称',
               '卫生间产品名称', '过道产品名称', '阳台产品名称', '儿童房产品名称', '产品类别']
...
class_tupe_dict1 = {
    ...
    AutoLayout.childrenroom.Base.Childrenroom.__name__: ['儿童房', CLASSIFIER_DATA[region_product_name[9]], CHILD]
}
...
def read_o1_xml_check_model(fname1, dataset=DATASET):
    xml = etree.parse(fname1)
    exception = []
    root = xml.getroot()
    flp_nd = [n for n in root.getchildren() if n.tag == House.__name__][0] \
...
def run_o1_xml_check_model(input, output):
    exception = []
    try:
        house, exception, _ = read_o1_xml_check_model(input)
        # house.draw()
        # helpers.save_house_to_xml(house, output)
        save_house_to_xml_o1(house, output)
        return exception
...
def test():
    ...
    #file = r'C:\Users\dyrs-ai-win10\Desktop\finally'
    file = r'C:\Users\dyrs-ai-win10\Desktop\forlxyandzml\100_xml'
    #file = r'D:\exe\test\\'
    # file = r'E:\jxh\subtasks\AutoLayoutTest\lv_test'
    # file = r'F:\bath_test'
    scale_list = []
    ...
    def ana_dir_xml(dir, finish_dir=None, jpg_dir=None ):
        xml_file = helpers.listfile(dir, postfix='xml')
...
def main():
    print('hi')
    # test()
    file1 = r'C:\Users\dyrs-ai-win10\Desktop\forlxyandzml\100_xml\lianjia_haidian_nongkeyuan_001.xml'
    # file1 = r'C:\Users\dyrs-ai-win10\Documents\Tencent Files\673722621\FileRecv\2018_05_18_10_26_06_d179ce4c-5a42-11e8-8daa-e0d55e49e470.xml'
    # file1 = r'C:\Users\dyrs-ai-win10\Desktop\xmltest\fenquao.xml'
